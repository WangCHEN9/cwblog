        ...
        <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8" key={post.title}>
            ...
            <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
                <div className='flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8'>
                    ...
                    />
                    <p className='inline alight-middle text-gray-700 ml-2 text-lg'>
                        {post.author.name}
                    </p>
                </div>
            ...
            <div className='text-center'>
                <Link href={`/post/${post.slug}`} passHref>
                    <span className='transition duration-500 transform hover:-translate-y-1 inline-block bg-pink-600 text-lg front-medium rounded-full tetx-white px-8 py-3 cursor-pointer'>Continue reading</span>
                </Link>
            </div>
        </div>
    )

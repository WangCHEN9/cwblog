 ...
 * });
 */
export function useCategoryPostQuery(baseOptions: Apollo.QueryHookOptions<CategoryPostQuery, CategoryPostQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CategoryPostQuery, CategoryPostQueryVariables>(CategoryPostDocument, options);
      }
export function useCategoryPostLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CategoryPostQuery, CategoryPostQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
